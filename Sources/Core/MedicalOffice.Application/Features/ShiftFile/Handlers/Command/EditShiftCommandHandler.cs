...
namespace MedicalOffice.Application.Features.ShiftFile.Handlers.Command
{
    ...
    public class EditShiftCommandHandler : IRequestHandler<EditShiftCommand, BaseCommandResponse>
    {
        ...
        public async Task<BaseCommandResponse> Handle(EditShiftCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                response.Data.Add(new { Id = shift.Id });
