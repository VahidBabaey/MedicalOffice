...
namespace MedicalOffice.Application.Features.InsuranceFile.Handlers.Commands
{
    ...
    public class EditInsuranceCommandHandler : IRequestHandler<EditInsuranceCommand, BaseCommandResponse>
    {
        ...
        public async Task<BaseCommandResponse> Handle(EditInsuranceCommand request, CancellationToken cancellationToken)
        {
