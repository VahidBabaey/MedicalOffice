...
namespace MedicalOffice.Application.Features.PatientIllnessFormFile.Handler.Command
{
    ...
    public class AddPatientCommitmentFormCommandHandler : IRequestHandler<AddPatientCommitmentFormCommand, BaseCommandResponse>
    {
        ...
        public async Task<BaseCommandResponse> Handle(AddPatientCommitmentFormCommand request, CancellationToken cancellationToken)
        {
            ...
            else
            {
                try
                {
                    ...
                    response.Data.Add(new { Id = patientCommitmentForm.Id });
