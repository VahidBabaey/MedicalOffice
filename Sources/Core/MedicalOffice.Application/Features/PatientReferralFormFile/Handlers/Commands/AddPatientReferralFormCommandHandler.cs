...
namespace MedicalOffice.Application.Features.PatientReferralFormFile.Handlers.Commands
{
    ...
    public class AddPatientReferralFormCommandHandler : IRequestHandler<AddPatientReferralFormCommand, BaseCommandResponse>
    {
        ...
        public async Task<BaseCommandResponse> Handle(AddPatientReferralFormCommand request, CancellationToken cancellationToken)
        {
            ...
            else
            {
                try
                {
                    ...
                    response.Data.Add(new { Id = patientreferralform.Id });
