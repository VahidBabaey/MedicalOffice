...
namespace MedicalOffice.Application.Features.ServiceFile.Handlers.Commands
{
    ...
    public class AddServiceTariffCommandHandler : IRequestHandler<AddServiceTariffCommand, BaseCommandResponse>
    {
        ...
        public async Task<BaseCommandResponse> Handle(AddServiceTariffCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                response.Data.Add(new { Id = tariff.Id });
