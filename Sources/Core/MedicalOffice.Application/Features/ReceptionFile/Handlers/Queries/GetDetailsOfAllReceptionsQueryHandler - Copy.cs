...
{
    public class GetDetailsOfAllReceptionsQueryHandler : IRequestHandler<GetDetailsOfAllReceptionsQuery, DetailsofAllReceptionsDTO>
    {
        ...
        public async Task<DetailsofAllReceptionsDTO> Handle(GetDetailsOfAllReceptionsQuery request, CancellationToken cancellationToken)
        {
