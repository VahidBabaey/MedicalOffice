...
public class UserWorkHourProgramRepository : GenericRepository<MedicalStaffWorkHourProgram, Guid>, IUserWorkHourProgramRepository
{
    ...
    {
        return (IReadOnlyList<MedicalStaffWorkHourProgram>)await _dbContext.UserWorkHourPrograms.Where(srv => srv.UserId == Id).ToListAsync();
    }
